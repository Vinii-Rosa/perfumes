        ...
        <div className="grid grid-cols-[1fr_1280px_1fr]">
            <div className="col-start-2 col-end-3 flex flex-col gap-20">
                <div className="flex flex-row justify-between">
                    <h1 className="font-normal">Novos produtos</h1>
                    <FillterButton/>
                </div>
                <div className="grid grid-cols-4 gap-20">
                    {products?.map((p, index) => {
                        return (
                            <div className="h-[400px] grid grid-rows-[3fr_1fr] gap-[5px]" key={index}>
                                ...
                                <button className="h-[35px] text-sm border border-gray-300 font-semibold hover:bg-[#1c1a17] hover:text-white flex items-center justify-center gap-[5px]">
